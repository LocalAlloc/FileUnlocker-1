	...
	if (hTheme)
	{
		...
		if (hdcPaint)
		{
			...
			if (hbm)
			{
				...
				WCHAR szBuffer[kb(1)];
				GetWindowTextW(GetDlgItem(hWnd, 1012), szBuffer, kb(1));
				...
				wsprintfW(szBuffer, L"Compiled with MSVC-%d in %S at %S.", _MSC_VER, __DATE__, __TIME__);
				DrawThemeTextEx(hTheme,
					hdcPaint,
					0, 0,
					szBuffer,
				...
				GetWindowTextW(GetDlgItem(hWnd, 1011), szBuffer, kb(1));
